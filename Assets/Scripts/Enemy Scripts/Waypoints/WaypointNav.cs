...
public class WaypointNav
{
    ...
    {
        clearWaypoints();
        nodePerimeterGen.createTriangleWaypoints();
    }
    ...
    private class NodePerimeterGen
    {
        ...
        public void createTriangleWaypoints()
        {
            findReachablePoints();
            ...
            for (int i = 0; i < 3; ++i)
            {
                ...
                removeWaypointsInProximity(point, 2f);
            }
        }
        ...
        private void removeWaypointsInProximity(Vector3 point, float distance)
        {
